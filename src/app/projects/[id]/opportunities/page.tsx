...
export default async function ProjectOpportunitiesPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {opps.length === 0 ? (
        <div className="rounded-lg border border-white/10 bg-white/5 p-6 text-white/70 flex items-center justify-between">
          <span>Henüz gösterilecek fırsat bulunamadı. Veri eklendikçe öneriler burada görünecektir.</span>
          <a
