...
export default function Page() {
  ...
  useEffect(() => {
    // Basic connectivity assumption since diagnoseSdkConnectivity may not be available in this SDK version
    setIsConnected(true);
  }, []);
    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://emir-ow.sentry.io/issues/?project=4510023940374608">Issues Page</a>.
